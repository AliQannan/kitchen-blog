...
// استيراد بيانات الأدوات
const kitchenToolsData = [
  // قم بنسخ ولصق بيانات الأدوات من ملفك الأصلي هنا
  {
    id: 1,
...
// يمكنك إنشاء مكون ToolCard في ملف منفصل (components/ToolCard.jsx) واستيراده
// لتجنب تكرار الكود
const ToolCard = ({ tool, index }) => {
  ...
  // قم باستيراد Navbar و AnimatedParticles إذا كانت موجودة في ملفات منفصلة
